package kr.co.api.core.db.construct;
...
public class SqlSessionFactoryBuilder {
    ...
    private static final String MAPPER_LOCATIONS_PATH = "classpath:/kr/co/api/manager/**/**/**/*.xml";
    private static final String TYPE_ALIASES_PACKAGE = "kr.co.api";
    private static final String TYPE_HANDLERS_PACKAGE = "kr.co.api";
