...
import kr.co.api.core.db.TransactionManagerName;
import kr.co.api.core.db.annotation.MasterConnection;
import kr.co.api.core.db.properties.DataSourceProperties;
...
class MyBatisConfig {
    public static final String BASE_PACKAGE = "kr.co.api";
}
